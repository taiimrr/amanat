...
<template>
  <v-container class="pa-6">
    ...
    <p class="text-body-2 text-medium-emphasis mb-6">Logged in as {{ auth.user?.email }}</p>
        ...
        <v-card color="primary" variant="tonal">
          <v-card-text>
            ...
            <v-list-item class="px-0 mt-1">
              ...
              <v-list-item-title>
                <v-chip color="secondary" size="small" label>{{ auth.user?.role }}</v-chip>
              </v-list-item-title>
            </v-list-item>
            <v-list-item class="px-0 mt-1">
              <v-list-item-subtitle>Status</v-list-item-subtitle>
              <v-list-item-title>
                <v-chip color="warning" size="small" label>APPLICANT</v-chip>
              </v-list-item-title>
            </v-list-item>
          </v-card-text>
        </v-card>
